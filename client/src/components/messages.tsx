...
const Messages: FunctionComponent<MessagesProps> = function (
  props: MessagesProps
) {
  const messagesParent = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const domNode: HTMLDivElement | null = messagesParent.current;
    if (domNode) {
